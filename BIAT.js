		...
		function getLayout(params)
		{
			...
			{//Show the starting stimuli with the instructions' layout.
				layout = layout.concat([				
					...
					{location:{top:1 + (params.focalCatTitle.height ) + (params.focalCatTitle.startStimulus.height )},
					...
					{location:{top:8 + 1 + (params.focalCatTitle.height | 3) + (params.focalCatTitle.startStimulus.height | 3) + (params.focalAttTitle.height | 3)}, 
